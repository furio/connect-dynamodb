...
module.exports = function (connect) {
    ...
    function DynamoDBStore(options) {
        ...
        this.reapInterval = 0; // options.reapInterval || (10 * 60 * 1000);
            ...
            if (err) {
                ...
                try {
                    if (!result.Item) return fn(null, null);
                    	...
                    	this.destroy(result.Item.id, function() { fn(null, null); });
                    } else {
                        var sess = null;
						if (result.Item.hasOwnProperty('sess')) {
							sess = result.Item.sess.S.toString();
